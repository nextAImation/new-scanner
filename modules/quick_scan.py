...
def save_report(data, ctx, out_dir):
    ...
    archive_csv_path, archive_json_path = generate_market_archive(
        ...
        archive_csv="market_archive.csv",
        archive_json="market_archive.json",
    )
    ...
    if MODULES_AVAILABLE:
        ...
        md.append(f"- Liquidity Heatmap: {g(d4, 'liquidity_heatmap')}")
    ...
    if MODULES_AVAILABLE:
        ...
        md.append(f"- Liquidity Heatmap: {g(d1, 'liquidity_heatmap')}")
